...
В этой папке собираются материалы для live-demo и публичного обзора проекта.

## Видео

- Видео-демо добавлено в корневой `README.md` (раздел про демо).
...
- [x] Добавлена ссылка на видео в `README.md`.
